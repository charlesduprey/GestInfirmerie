...
namespace UtilisateursDAL
{
    public class MedicamentDAO
    {
        ...
        public static int UpdateMedicament(Medicament unMedicament)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = maConnexion;
            cmd.CommandText = "UPDATE ELEVES SET id_medic = '" + unMedicament.IdMdc + "', libelle_medic = '" + unMedicament.LblMdc + "', archivage_medic = '" + unMedicament.ArchivageMdc + "' WHERE id_medic = " + unMedicament.IdMdc;
