...
namespace UtilisateursGUI
{
    public partial class AffichageInfos : Form
    {
        ...
        public AffichageInfos()
        {
			...
			// Initialisation du nombre total de visites en fonction de la période
            NbtotVstP.Text = GestionVisite.GetNbVstMaxP(dateDebut.Value.ToString(), dateFin.Value.ToString()).ToString() + " visites ";

            // Initialisation du nombre de visites max en fonction de la periode
            nbVstEP.Text = GestionVisite.GetNbVstMoy(dateDebut.Value.ToString(), dateFin.Value.ToString()).ToString();

            // Initialisation du temps moyen d'une visite en fonction d'une période
            tpsMoyVst.Text = GestionVisite.GetTpsMoyVst(dateDebut.Value, dateFin.Value) + " minutes";
        }
        #endregion
